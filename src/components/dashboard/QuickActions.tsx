...
import { TrendingUp, Package, CheckSquare } from "lucide-react";

const actions = [
  { label: "Gelir Ekle",    icon: TrendingUp,  color: "#22c55e", href: "/nakit-akisi?modal=gelir",  rotate: false },
  { label: "Gider Ekle",    icon: TrendingUp,  color: "#ef4444", href: "/nakit-akisi?modal=gider",  rotate: true  },
  { label: "Stok Güncelle", icon: Package,      color: "#fbc024", href: "/stok?modal=urun-ekle",     rotate: false },
  ...
  return (
    <div className="glass-card rounded-2xl p-5">
      ...
      <div className="grid grid-cols-2 gap-2">
        {actions.map(({ label, icon: Icon, color, href, rotate }, i) => (
          <motion.button
            key={label}
          ...
          >
            ...
            >
              <Icon
                ...
                style={{ color, transform: rotate ? "scaleY(-1)" : undefined }}
              />
            </div>
